...
public class Audits implements IReportType{
	
	
	private static final String REPORT_DESIGN = "audits.rptdesign"; //$NON-NLS-1$

	public String getDescription() {
		return Messages.AuditReport_0;
	}

	public String getId() {
		return "audits"; //$NON-NLS-1$
	}
	...
	public void createReport(IReportOptions reportOptions) {
		...
		URL reportDesign = Audits.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
