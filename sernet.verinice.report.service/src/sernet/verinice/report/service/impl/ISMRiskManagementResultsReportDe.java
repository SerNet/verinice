 ...
 *
 */
public class ISMRiskManagementResultsReportDe implements IReportType {
    
    private static final String REPORT_DESIGN = "ismRiskManagementResults_de.rptdesign"; //$NON-NLS-1$
    ...
    public String getLabel() {
        return Messages.ISMRiskManagementResultsDe_2;
    }
    ...
    public String getDescription() {
        return Messages.ISMRiskManagementResultsDe_1;
    }
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = ISMRiskManagementResultsReportDe.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
    ...
    public String getReportFile() {
        return Messages.ISMRiskManagementResultsDe_0;
    }
