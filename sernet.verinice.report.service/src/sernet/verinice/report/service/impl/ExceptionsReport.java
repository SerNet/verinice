 ...
 *
 */
public class ExceptionsReport implements IReportType {
    
    private static final Logger LOG = Logger.getLogger(ExceptionsReport.class);
    
    private static final String REPORT_DESIGN = "exceptions.rptdesign"; //$NON-NLS-1$
    ...
    public String getLabel() {
        return Messages.ExceptionsReport_2;
    }
    ...
    public String getDescription() {
        return Messages.ExceptionsReport_1;
    }
    ...
    public String getReportFile() {
        return Messages.ExceptionsReport_0;
    }
