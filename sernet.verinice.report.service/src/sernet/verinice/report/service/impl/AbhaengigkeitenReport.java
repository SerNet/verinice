...
public class AbhaengigkeitenReport implements IReportType {
	
	private static final Logger LOG = Logger.getLogger(AbhaengigkeitenReport.class);
	
    private static final String REPORT_DESIGN = "Abhaengigkeiten.rptdesign"; //$NON-NLS-1$

	public String getDescription() {
		return Messages.AbhaengigkeitenReport_1;
	}

	public String getId() {
		return "abhaengigkeiten"; //$NON-NLS-1$
	}
	...
	public void createReport(IReportOptions reportOptions) {
		...
		URL reportDesign = AbhaengigkeitenReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
