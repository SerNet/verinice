 ...
 *
 */
public class ISAActionReport implements IReportType {
    
    private static final String REPORT_DESIGN = "ISA-ActionReport.rptdesign";
    ...
    public IOutputFormat[] getOutputFormats() {
        return new IOutputFormat[] { new HTMLOutputFormat(), new PDFOutputFormat(), new ExcelOutputFormat(), new ODSOutputFormat()};
    }
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = ISAActionReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
