 ...
 *
 */
public class ExistingRisksReport implements IReportType {

    private static final String REPORT_DESIGN = "ExistingRisks.rptdesign"; //$NON-NLS-1$
    
    @Override
    public String getId() {
        return "existingRisks"; // $NON-NLS-1$
    }

    @Override
    public String getLabel() {
        return Messages.ExistingRisksReport_1;
    }

    @Override
    public String getDescription() {
        return Messages.ExistingRisksReport_0;
    }
