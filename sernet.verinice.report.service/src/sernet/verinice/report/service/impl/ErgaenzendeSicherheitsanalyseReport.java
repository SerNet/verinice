...
public class ErgaenzendeSicherheitsanalyseReport implements IReportType {
	...
	private static final Logger LOG = Logger.getLogger(ErgaenzendeSicherheitsanalyseReport.class);
	
    private static final String REPORT_DESIGN = "Ergaenzende-Sicherheitsanalyse.rptdesign"; //$NON-NLS-1$

	public String getDescription() {
		return Messages.ErgaenzendeSicherheitsanalyseReport_0;
	}

	public String getId() {
		return "ergaenzendesicherheitsanalyse"; //$NON-NLS-1$
	}

	public String getLabel() {
		return Messages.ErgaenzendeSicherheitsanalyseReport_1;
	}
	...
	public void createReport(IReportOptions reportOptions) {
		...
		URL reportDesign = ErgaenzendeSicherheitsanalyseReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
    ...
    public String getReportFile() {
        return Messages.ErgaenzendeSicherheitsanalyseReport_2;
    }
