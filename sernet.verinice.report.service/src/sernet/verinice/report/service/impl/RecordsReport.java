...
public class RecordsReport implements IReportType {
    ...
    private static final Logger LOG = Logger.getLogger(RecordsReport.class);
    
    private static final String REPORT_DESIGN = "records.rptdesign"; //$NON-NLS-1$
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = RecordsReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
