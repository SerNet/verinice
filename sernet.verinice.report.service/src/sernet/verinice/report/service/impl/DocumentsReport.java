 ...
 *
 */
public class DocumentsReport implements IReportType {
    
    private static final Logger LOG = Logger.getLogger(DocumentsReport.class);
    
    private static final String REPORT_DESIGN = "documents.rptdesign"; //$NON-NLS-1$
    ...
    public String getLabel() {
        return Messages.DocumentsReport_2;
    }
    ...
    public String getDescription() {
        return Messages.DocumentsReport_1;
    }
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = DocumentsReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
    ...
    public String getReportFile() {
        return Messages.DocumentsReport_0;
    }
