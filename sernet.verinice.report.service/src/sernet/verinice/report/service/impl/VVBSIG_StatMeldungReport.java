 ...
 *
 */
public class VVBSIG_StatMeldungReport implements IReportType {
    
    private static final String REPORT_DESIGN = "VVBSIG_statGesamtMeldung.rptdesign";
    ...
    @Override
    public String getId() {
        return "vvbsig_statGesamtMeldung";
    }
    ...
    public String getLabel() {
        return Messages.VVBSIGStatMeldung_2;
    }
    ...
    public String getDescription() {
        return Messages.VVBSIGStatMeldung_1;
    }
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = VVBSIG_StatMeldungReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
    ...
    public String getReportFile() {
        return Messages.VVBSIGStatMeldung_0;
    }
