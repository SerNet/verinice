 ...
 *
 */
public class PersonsReport implements IReportType {
    
    private static final Logger LOG = Logger.getLogger(PersonsReport.class);
    
    private static final String REPORT_DESIGN = "persons.rptdesign"; //$NON-NLS-1$
    ...
    public String getLabel() {
        return Messages.PersonsReport_2;
    }
    ...
    public String getDescription() {
        return Messages.PersonsReport_1;
    }
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = PersonsReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
    ...
    public String getReportFile() {
        return Messages.PersonsReport_0;
    }
