 ...
 *
 */
public class ProcessesReport implements IReportType {
    
    private static final Logger LOG = Logger.getLogger(ProcessesReport.class);
    
    private static final String REPORT_DESIGN = "processes.rptdesign"; //$NON-NLS-1$
    ...
    public String getLabel() {
        return Messages.ProcessesReport_2;
    }
    ...
    public String getDescription() {
        return Messages.ProcessesReport_1;
    }
    ...
    public void createReport(IReportOptions reportOptions) {
        ...
        URL reportDesign = ProcessesReport.class.getResource(REPORT_DESIGN); //$NON-NLS-1$
    ...
    public String getReportFile() {
        return Messages.ProcessesReport_0;
    }
