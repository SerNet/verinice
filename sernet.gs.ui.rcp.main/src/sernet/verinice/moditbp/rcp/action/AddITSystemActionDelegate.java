 ...
 *
 */
public class AddITSystemActionDelegate extends AbstractAddModITBPElementActionDelegate {
    ...
    public void run(IAction action) {
        ...
        try {
            ...
            if (sel instanceof ITSystemCategory) {
                ...
                newElement = CnAElementFactory.getInstance().saveNew(cont, ItSystem.TYPE_ID, null, inheritIcon);
            }
            if (newElement != null) {
                EditorFactory.getInstance().openEditor(newElement);
            }
        } catch (Exception e) {
            ExceptionUtil.log(e, Messages.AddITSystemDelegate_0);
        }
