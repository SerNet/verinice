 ...
 *
 */
public class AddNetworkActionDelegate extends AbstractAddModITBPElementActionDelegate {
    ...
    public void run(IAction action) {
        ...
        try {
            ...
            if (sel instanceof NetworkCategory) {
                ...
                newElement = CnAElementFactory.getInstance().saveNew(cont, Network.TYPE_ID, null, inheritIcon);
            }
            if (newElement != null) {
                EditorFactory.getInstance().openEditor(newElement);
            }
        } catch (Exception e) {
            ExceptionUtil.log(e, Messages.AddNetworkDelegate_0);
        }
