...
public class Interview extends CnATreeElement implements IISO27kElement {
	...
	public Interview(CnATreeElement parent) {
		...
		getEntity().createNewProperty(getEntityType().getPropertyType(PROP_NAME), "New Interview");
	}
