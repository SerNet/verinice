...
public class ExceptionGroup extends Group<Exception> {
	...
	public static final String TITLE_DEFAULT = "Exceptions"; //$NON-NLS-1$
	public static final String PROP_NAME = "exceptiongroup_name"; //$NON-NLS-1$
	
	public static final String[] CHILD_TYPES = new String[] {Exception.TYPE_ID};
	...
	public ExceptionGroup(CnATreeElement parent) {
		super(parent);
