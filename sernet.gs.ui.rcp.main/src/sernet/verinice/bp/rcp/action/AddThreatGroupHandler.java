...
/**
 * Handler to add new threat groups to target objects in the modernized base
 * protection
 */
public class AddThreatGroupHandler extends AddGroupHandler {
