...
/**
 * Handler to add new requirement groups to target objects in the modernized
 * base protection
 */
public class AddRequirementGroupHandler extends AddGroupHandler {
    ...
    protected String getTypeIdForNewGroup(CnATreeElement parent) {
        return BpRequirementGroup.TYPE_ID;
    }
