 ...
 *
 */
public class AddBpThreatActionDelegate extends AbstractAddBpElementActionDelegate {
    ...
    public void run(IAction action) {
        ...
        try {
            ...
            if (sel instanceof BpThreatGroup) {
                ...
                newElement = CnAElementFactory.getInstance().saveNew(cont, BpThreat.TYPE_ID, null, inheritIcon);
            }
            if (newElement != null) {
