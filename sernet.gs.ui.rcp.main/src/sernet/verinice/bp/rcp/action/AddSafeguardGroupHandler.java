...
/**
 * Handler to add new safeguard groups to target objects in the modernized base
 * protection
 */
public class AddSafeguardGroupHandler extends AddGroupHandler {
