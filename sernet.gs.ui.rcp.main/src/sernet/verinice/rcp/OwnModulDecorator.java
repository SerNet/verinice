 ...
 * 
 */
public class OwnModulDecorator extends LabelProvider implements
		ILightweightLabelDecorator {
	
	
	private static final Logger LOG = Logger.getLogger(OwnModulDecorator.class);

	public static final String IMAGE_PATH = "overlays/add_stat.gif";
	...
	public void decorate(Object o, IDecoration decoration) {
		if (o instanceof BausteinUmsetzung) {
			...
			if (baustein.getUrl() == null || baustein.getUrl().isEmpty()
					|| baustein.getUrl().equals("null")) {

				decoration.addOverlay(ImageCache.getInstance()
						.getImageDescriptor(IMAGE_PATH));
}
