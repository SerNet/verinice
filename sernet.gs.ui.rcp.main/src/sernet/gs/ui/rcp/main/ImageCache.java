...
public final class ImageCache {
    ...
    // FIXME ak exception sving element, entity exists in session with separate
    // instance...
    ...
    static {
        ...
        TYPE_ID_ICON_MAP.put(sernet.verinice.model.iso27k.Process.TYPE_ID,
                ImageCache.ISO27K_PROCESS);
    ...
    public Image getCustomImage(String url) {
        ...
        if (new File(url).isAbsolute()) {
            ...
            descriptor = ImageDescriptor
                    .createFromURL(FileLocator.find(bundle, new Path(url), null));
        }
