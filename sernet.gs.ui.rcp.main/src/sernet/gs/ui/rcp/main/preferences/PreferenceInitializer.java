...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        ...
        store.setDefault(PreferenceConstants.DB_DRIVER, PreferenceConstants.DB_DRIVER_DERBY);
        ...
        store.setDefault(PreferenceConstants.OPERATION_MODE,
                PreferenceConstants.OPERATION_MODE_INTERNAL_SERVER);

        store.setDefault(PreferenceConstants.VNSERVER_URI,
                PreferenceConstants.VNSERVER_URI_DEFAULT);
        ...
        store.setDefault(PreferenceConstants.REPORT_LOCAL_TEMPLATE_DIRECTORY,
        ...
        store.setDefault(PreferenceConstants.SEARCH_SORT_COLUMN_BY_SNCA,
                PreferenceConstants.SEARCH_SORT_COLUMN_BY_SNCA);
        store.setDefault(PreferenceConstants.SEARCH_CSV_EXPORT_SEPERATOR,
                SearchPreferencePage.SEMICOLON);
        store.setDefault(PreferenceConstants.SEARCH_CSV_EXPORT_ENCODING,
                VeriniceCharset.CHARSET_WINDOWS_1250.name());
        ...
        store.setDefault(PreferenceConstants.STANDALONE_UPDATENEWS_URL,
                STANDALONE_UPDATENEWS_URL_DEFAULT);
