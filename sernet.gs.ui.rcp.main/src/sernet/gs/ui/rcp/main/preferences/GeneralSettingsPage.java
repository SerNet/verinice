...
public class GeneralSettingsPage extends FieldEditorPreferencePage
    ...
    static final String[][] ENCODING_COMBO_VALUES = new String[][] {
            ...
            new String[] { VeriniceCharset.CHARSET_ISO_8859_15.displayName(),
                    VeriniceCharset.CHARSET_ISO_8859_15.name() },
            new String[] { VeriniceCharset.CHARSET_WINDOWS_1252.displayName(),
                    VeriniceCharset.CHARSET_WINDOWS_1252.name() } };
    ...
    public void createFieldEditors() {
        final BooleanFieldEditor derbyWarning = new BooleanFieldEditor(
                PreferenceConstants.FIRSTSTART, Messages.getString("GeneralSettingsPage.1"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(derbyWarning);

        final BooleanFieldEditor linkToEditor = new BooleanFieldEditor(
                PreferenceConstants.LINK_TO_EDITOR, Messages.getString("GeneralSettingsPage.4"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(linkToEditor);

        final BooleanFieldEditor errorPopups = new BooleanFieldEditor(
                PreferenceConstants.ERRORPOPUPS, Messages.getString("GeneralSettingsPage.2"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(errorPopups);

        final BooleanFieldEditor inputHelperHints = new BooleanFieldEditor(
                PreferenceConstants.INPUTHINTS, Messages.getString("GeneralSettingsPage.3"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(inputHelperHints);

        final BooleanFieldEditor showDBIDDecorator = new BooleanFieldEditor(
                PreferenceConstants.SHOW_DBID_DECORATOR,
                Messages.getString("GeneralSettingsPage.ShowDBIDDecorator"), //$NON-NLS-1$
                getFieldEditorParent());
        ...
        final BooleanFieldEditor showSecurityLevelDecorator = new BooleanFieldEditor(
                ...
                getFieldEditorParent());
        addField(showSecurityLevelDecorator);

        final BooleanFieldEditor useValidationGuiHints = new BooleanFieldEditor(
                PreferenceConstants.USE_VALIDATION_GUI_HINTS,
                Messages.getString("GeneralSettingsPage.UseValidationGuiHints"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(useValidationGuiHints);

        final BooleanFieldEditor useAutomaticValidation = new BooleanFieldEditor(
                PreferenceConstants.USE_AUTOMATIC_VALIDATION,
                Messages.getString("GeneralSettingsPage.UseValidationAlways"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(useAutomaticValidation);

        final BooleanFieldEditor inheritSpecialIcon = new BooleanFieldEditor(
                PreferenceConstants.INHERIT_SPECIAL_GROUP_ICON,
                Messages.getString("GeneralSettingsPage.InheritSpecialIcon"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(inheritSpecialIcon);

        final BooleanFieldEditor cutInheritPermissions = new BooleanFieldEditor(
                PreferenceConstants.CUT_INHERIT_PERMISSIONS,
                Messages.getString("GeneralSettingsPage.CutInheritPermissions"), //$NON-NLS-1$
                getFieldEditorParent());

        addField(cutInheritPermissions);

        final BooleanFieldEditor copyAttachmentsWithObjects = new BooleanFieldEditor(
                PreferenceConstants.COPY_ATTACHMENTS_WITH_OBJECTS,
                Messages.getString("GeneralSettingsPage.CopyAttachmentsWithObjects"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(copyAttachmentsWithObjects);

        final BooleanFieldEditor enableReleaseProcess = new BooleanFieldEditor(
                PreferenceConstants.ENABLE_RELEASE_PROCESS,
                Messages.getString("GeneralSettingsPage.UseReleaseProcess"), //$NON-NLS-1$
                getFieldEditorParent());
        addField(enableReleaseProcess);

        final ComboFieldEditor thumbnailSizeEditor = new ComboFieldEditor(
                PreferenceConstants.THUMBNAIL_SIZE, Messages.getString("GeneralSettingsPage.7"), //$NON-NLS-1$
