...
public class MigrateDbTo1_02D extends DbMigration {
    ...
    private static final String GEFAERHDUNG_TMP_COLUMN_NAME = "TMP_DESC_GEF";
    ...
    static {
        ...
        DERBY_SQL_LIST.add("ALTER TABLE OWNGEFAEHRDUNG ADD COLUMN " + GEFAERHDUNG_TMP_COLUMN_NAME + " VARCHAR (32672)");
        DERBY_SQL_LIST.add("UPDATE OWNGEFAEHRDUNG SET "+ GEFAERHDUNG_TMP_COLUMN_NAME + "=BESCHREIBUNG");
        DERBY_SQL_LIST.add("ALTER TABLE OWNGEFAEHRDUNG DROP COLUMN BESCHREIBUNG");
        DERBY_SQL_LIST.add("RENAME COLUMN OWNGEFAEHRDUNG." + GEFAERHDUNG_TMP_COLUMN_NAME +" TO BESCHREIBUNG");
    }
    ...
    static {
        ...
        ORACLE_SQL_LIST.add("ALTER TABLE OWNGEFAEHRDUNG ADD " + GEFAERHDUNG_TMP_COLUMN_NAME + " NCLOB");
        ORACLE_SQL_LIST.add("UPDATE OWNGEFAEHRDUNG SET " + GEFAERHDUNG_TMP_COLUMN_NAME + "=BESCHREIBUNG");
        ORACLE_SQL_LIST.add("ALTER TABLE OWNGEFAEHRDUNG DROP COLUMN BESCHREIBUNG");
        ORACLE_SQL_LIST.add("ALTER TABLE OWNGEFAEHRDUNG RENAME COLUMN " + GEFAERHDUNG_TMP_COLUMN_NAME + " TO BESCHREIBUNG");
    }
    
    private static final String POSTGRE_SQL = "ALTER TABLE risikomassnahme ALTER COLUMN description TYPE varchar(400000);\n"
            + "ALTER TABLE owngefaehrdung ALTER COLUMN beschreibung TYPE varchar(400000)";
