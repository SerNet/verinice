...
/**
 * Mark a threat as "OK" which menas it does not need further evaluation during
 * risk analysis.
 * 
...
public class PositiveEstimateGefaehrdung extends GenericCommand {
     ...
     */
    public PositiveEstimateGefaehrdung(Integer dbId, GefaehrdungsUmsetzung gefaehrdungsUmsetzung, CnATreeElement finishedRiskAnalysis) {
    ...
    public void execute() {
        // attach objects:
        finishedRiskLists = getFinishedRiskAnalysisListsDao().findById(listsDbId);    
    ...
    public void clear() {
        ...
        HydratorUtil.hydrateElement(getFinishedRiskAnalysisListsDao(), finishedRiskLists);
