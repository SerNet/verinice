...
/**
 * Constants for paths where actions can be added by other bundles
 * to verinice.
 * 
 * A list of full paths for reference is maintained here:
 * 
 * Window Menu:
 * - /window/vn_menu_views/additions
 * 
 * 
