...
public class BSIMassnahmenModel {
     ...
     * @throws IOException
     */
    public synchronized List<Baustein> loadBausteine(IProgress mon) throws GSServiceException, IOException {
    ...
    private void processBausteinLayer(IProgress mon, List<Baustein> alleBst, String layer, int layerDescription) throws GSServiceException, IOException {
    ...
    private List<Baustein> loadBausteineRemote() throws GSServiceException {
        ...
        try {
            ...
            // TODO rschuster: Display a nice error dialog and asking the user
            // to
            // check whether the server URL is valid (or the server is down?)
            // If this happens in internal server mode than something is very
            // bad.
