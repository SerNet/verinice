...
/**
 * Starts the wizard for a risk analysis according to BSI-Standard 100-3.
 * 
...
public class NeueRisikoanalyseAction implements IObjectActionDelegate {
     ...
     * time the action appears in a popup menu.
     * 
     * @param action
    ...
    public void run(IAction action) {
        ...
        final Object selection = ((IStructuredSelection) targetPart.getSite().getSelectionProvider()
    ...
    /**
     * Not used. Must be implemented due to IActionDelegate.
     * 
     * @param action
     *            the action proxy that handles presentation portion of the
     *            action
    ...
    public void selectionChanged(IAction action, ISelection selection) {
        ...
        if (sel instanceof IBSIStrukturKategorie) {
            ...
            // To make a risk analysis one needs write permission for the object
            // in question.
