...
public class AddClientActionDelegate extends AbstractAddCnATreeElementActionDelegate {
    ...
    public void run(IAction action) {
        ...
        try {
            ...
            if (sel instanceof ClientsKategorie) {
                ...
                newElement = CnAElementFactory.getInstance().saveNew(cont, Client.TYPE_ID, null, inheritIcon);
            }
            if (newElement != null) {
                EditorFactory.getInstance().openEditor(newElement);
            }
        } catch (Exception e) {
            ExceptionUtil.log(e, Messages.AddClientActionDelegate_0);
        }
