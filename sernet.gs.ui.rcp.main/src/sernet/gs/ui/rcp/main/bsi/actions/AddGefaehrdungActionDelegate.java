 ...
 */
public class AddGefaehrdungActionDelegate extends AddModulandMethodActionDelegate {
        ...
        try {
            ...
            Object sel = ((IStructuredSelection) targetPart.getSite().getSelectionProvider().getSelection()).getFirstElement();
               if (sel instanceof CnATreeElement) {
                ...
                CnATreeElement  newGefaehrdung = CnAElementFactory.getInstance().saveNew(parent, GefaehrdungsUmsetzung.TYPE_ID, null, inheritIcon);
                
                EditorFactory.getInstance().openEditor(newGefaehrdung);
            }
