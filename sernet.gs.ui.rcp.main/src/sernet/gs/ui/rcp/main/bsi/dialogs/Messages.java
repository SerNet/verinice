...
public final class Messages extends NLS {
    ...
    public static String PersonBulkEditDialog_UserAccountSettings;
    public static String PersonBulkEditDialog_Password;
    public static String PersonBulkEditDialog_RetypePassword;
    ...
    public static String CnATreeElementSelectionDialog_11;
    ...
    public static String XMLImportDialog_Import_As_Catalog_Model;
    public static String XMLImportDialog_Import_As_Catalog_Option;
    public static String XMLImportDialog_Import_As_Catalog_Option_Description;
