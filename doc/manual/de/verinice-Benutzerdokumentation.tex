...
\newline\\
Um eine andere Sprache einzustellen, fügen Sie am Ende der Datei eine neue Zeile ein. Wenn Sie verinice in Englisch benutzen wollen, tragen Sie diese Zeile ein:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}{
{\tt -Dosgi.nl=en}
}}
\newline\\
Wenn verinice in deutscher Sprache benutzt werden soll, muss stattdessen diese Zeile eingetragen werden:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}{
{\tt -Dosgi.nl=de}
}}
...
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}
{\tt JAVA\_OPTS=\dq-Duser.language=en -Duser.region=EN\dq}}
\newline\\
Stellen Sie folgendes ein, um die deutsche Sprache zu erhalten:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}
{\tt JAVA\_OPTS=\dq-Duser.language=de -Duser.region=DE\dq}}
\newline\\
