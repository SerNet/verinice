...
\raisebox{-0.6\height}{\includegraphics{Icon/Control_Kataloge.png}} & Control catalogs \\[10pt] \hline
...
\item \textbf{Encoding of new catalogs: }
   ...
   This is about setting the character encoding when importing CSV data (see the {\em \ref{sec:generic-csv-import} \nameref{sec:generic-csv-import}} section.)
...
Above all, this shifts the focus to the \textbf{Control catalogs} \icon{Icon/Control_Kataloge.png},
...
\begin{itemize}
\item \icon{Icon/Control_Kataloge.png} Catalogs - Configure the encoding for each catalog individually in the Catalog view for importing your own catalogs.
...
\icon{Icon/Control_Kataloge.png} you can import controls
...
\icon{Icon/GS_Kataloge.png} and can therefore be added to
the appropriate objects in the \textbf{ISM View}
\icon{Icon/Informationssicherheitsmodell.png} using drag
and drop.

\subsection{Importing catalogs}
You can import a catalog by clicking on the \icon{Icon/Oeffnen.png} icon (in the \textbf{Catalog view} toolbar).
...
\end{figure}
\newline
The Catalog view \icon{Icon/Control_Kataloge.png} is also organized as a tree structure.
...
\newline\\
You can delete a catalog by clicking on the \icon{Icon/Delete.png} icon. The filter function
\icon{Icon/Filter.png} lets you perform a keyword search in the headers and texts. The search starts
automatically while you are typing the search key. The matches are displayed directly in the tree structure.
\newline\\
The Catalogs view \icon{Icon/Control_Kataloge.png}
...
To add \textbf{controls} \icon{Icon/Controls.png} in the \textbf{Information Security Model}
\icon{Icon/Informationssicherheitsmodell.png} drag and drop the desired control from Catalog view
\icon{Icon/Control_Kataloge.png} into the Controls group in the ISM View \icon{Icon/Informationssicherheitsmodell.png}.
...
\textbf{Information Security Model} \icon{Icon/Informationssicherheitsmodell.png} view.
Using this method, you can also add a whole control group to the ISM view \icon{Icon/Informationssicherheitsmodell.png}
while keeping its group structure.
\newline\\
In addition, you can create enterprise-specific controls. To do this, right-click \textbf{Controls} \icon{Icon/Controls.png}
...
\icon{Icon/Disk.png} in the toolbar.

\subsection{Using threats/vulnerabilities/risk scenarios}
In a similar way to \textbf{Controls} \icon{Icon/Controls.png}, \textbf{vulnerabilities} \icon{Icon/Schwachstellen.png} and
\textbf{threats} can be drag and dropped from the catalog entries and into the appropriate \textbf{Information Security Model} \icon{Icon/Informationssicherheitsmodell.png}
groups.
Threats \icon{Icon/Lightening.png}, vulnerabilities \icon{Icon/Schwachstellen.png} or scenarios \icon{Icon/Szenarios.png}
