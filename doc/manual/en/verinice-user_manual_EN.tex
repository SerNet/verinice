...
\newline\\
To change the language, add a new line at the end of the file. If you want to use verinice in English, enter this line:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}{
{\tt -Dosgi.nl=en}
}}
\newline\\
If verinice is to be used in German, this line must be entered instead:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}{
{\tt -Dosgi.nl=de}
}}
...
\newline\\
Set the following to configure the English language:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}{
{\tt JAVA\_OPTS="-Duser.language=en -Duser.region=EN"}
}}
\newline\\
Set the following to configure the German language:
\newline\\
\colorbox{lightgray}{\parbox{\textwidth}{
{\tt JAVA\_OPTS="-Duser.language=de -Duser.region=DE"}
}}
\newline\\
...
button \includegraphics[height=2ex]{Icon/folder_table.png} in the
