...
public class RiskAnalysisServiceTest extends CommandServiceProvider {
    ...
    @Test
    public void testRiskAnalysis() throws CommandException, IOException {
    ...
    public void checkRiskValues(Asset asset) {
        assertEquals(1, asset.getNumericProperty(Asset.ASSET_CONFIDENTIALITY_WITH_CONTROLS));
        assertEquals(2,
        ...
        assertEquals(6, asset.getNumericProperty(Asset.ASSET_CONTROLRISK_C));
        assertEquals(5, asset.getNumericProperty(Asset.ASSET_PLANCONTROLRISK_C));
        assertEquals(6, asset.getNumericProperty(Asset.ASSET_WITHOUT_NA_PLANCONTROLRISK_C));
    ...
    public void checkRiskValues(CnALink link) {
        ...
        assertEquals(Integer.valueOf(6), link.getRiskConfidentialityWithControls());
