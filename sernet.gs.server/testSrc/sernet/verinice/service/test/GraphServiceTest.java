...
public class GraphServiceTest extends BeforeEachVNAImportHelper {
    ...
    public void testLoadNode() throws Exception {
        ...
        VeriniceGraph graph = createGraph(null,
                new String[] { Asset.TYPE_ID, Control.TYPE_ID, IncidentScenario.TYPE_ID }, null);
    ...
    public void testLoadAllRelations() throws Exception {
        ...
        VeriniceGraph graph = createGraph(org.getDbId(), new String[] { Asset.TYPE_ID,
                Control.TYPE_ID, IncidentScenario.TYPE_ID, Vulnerability.TYPE_ID, Threat.TYPE_ID },
                null);
    ...
    public void testLoadRelations() throws Exception {
        CnATreeElement org = loadElement(SOURCE_ID, EXT_ID_ORG);
        VeriniceGraph graph = createGraph(org.getDbId(),
                new String[] { Asset.TYPE_ID, Control.TYPE_ID, IncidentScenario.TYPE_ID,
                        Vulnerability.TYPE_ID, Threat.TYPE_ID },
    ...
    private VeriniceGraph createGraph(Integer scopeId, String[] typeIds, String[] relationsTypeIds)
