 ...
 * 
 * <h2>
 * The test algorithm works as follows:</h2>
 * <ol>
 * <li>Set the reference by hand (dotted lines).</li>
 * <li>Export ITVerbund 1 the file as temporarily vna file.
 * <li>Delete ITVerbund 1 and ITVerbund 2 from the database.</li>
 ...
 *
 */
public class PartiallyExportAndImportReferencesTest extends BeforeEachVNAImportHelper {
    ...
    private static final String IT_VERBUND_2_EXTERNAL_ID = "ENTITY_425984";
    ...
    private static final String TARGET_PERSON_3_EXTERNAL_ID = "ENTITY_425985";
    ...
    private static final String SOURCE_ID = "5130ec";
    private static final String VNA_FILENAME = "export_import_uncomplete_references.vna";
    
    private final Logger LOG = Logger.getLogger(PartiallyExportAndImportReferencesTest.class);
    ...
    public void testExportAndImportOfHuiReferences() throws CommandException, IOException, SyncParameterException {
        ...
        CnATreeElement itVerbund2 = loadElement(SOURCE_ID, IT_VERBUND_2_EXTERNAL_ID);
        ...
        CnATreeElement targetPerson3 = loadElement(SOURCE_ID, TARGET_PERSON_3_EXTERNAL_ID);
        ...
        Integer targetPerson3EntityId = targetPerson3.getEntity().getDbId();
        ...
        sourceEntity.createNewProperty(propertyType, String.valueOf(targetPerson3EntityId));
        ...
        String filePath = FilenameUtils.concat(System.getProperty(
        ...
        LOG.info(EXPORT_REFERENCES_PREFIX + " remove itverbund " + itVerbund2.getTitle());
        removeITVerbund(itVerbund2);
