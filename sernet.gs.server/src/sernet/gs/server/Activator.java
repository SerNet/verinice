...
public class Activator extends Plugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		// Starts the Spring OSGi Extender which provides registering the Spring namespace handlers. If you get
		// exception saying there is no schema for Spring security, then the OSGi extender is not running.
