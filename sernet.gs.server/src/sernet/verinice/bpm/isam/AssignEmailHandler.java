 ...
 */
public class AssignEmailHandler extends GenericEmailHandler implements IEmailHandler {
    
    private static final Logger LOG = Logger.getLogger(AssignEmailHandler.class);
    
    private static final String TEMPLATE = "AssignReminder";
    ...
    public void addParameter(String uuidElement, Map<String, String> parameter) {
        ...
        parameter.put(IRemindService.TEMPLATE_SUBJECT, "Set assignee for: " + title); 
    }
