...
/**
 * Email handler for use in JBPM workflows. You have to override methods
 * addParameter(), getTemplate() in your implementation.
 * 
...
public abstract class GenericEmailHandler implements IEmailHandler {
    ...
    /**
     * Loads user based data calls abstract method addParameter ans sends email
     * by {@link IRemindService}.
     * 
     * @see sernet.verinice.bpm.IEmailHandler#send(java.lang.String,
     *      java.lang.String)
     */
    @Override
    public void send(String assignee, String type, Map<String, Object> processVariables,
        ...
        try {
            ...
            validate(processVariables, userParameter); // throws AbortException
                                                       // if it fails
