...
public class PersonDaoImpl implements IPersonDao {
    ...
    private final class LdapPersonMapper implements AttributesMapper {
        ...
        private CnATreeElement determineEmailPhone(Attributes attrs, CnATreeElement person)
        ...
        private CnATreeElement determineSurname(Attributes attrs, CnATreeElement person)
                throws NamingException {
            String surname = null;
        ...
        private CnATreeElement determineGivenName(Attributes attrs, CnATreeElement person)
                throws NamingException {
