...
public class SearchServiceDummy implements ISearchService {
     ...
     * @see
     * sernet.verinice.interfaces.search.ISearchService#query(sernet.verinice.
     * model.search.VeriniceQuery, java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * sernet.verinice.interfaces.search.ISearchService#remove(sernet.verinice.
     ...
     * 
     * @see
     * sernet.verinice.interfaces.search.ISearchService#add(sernet.verinice.
     * model.common.CnATreeElement)
     */
    @Override
     ...
     * 
     * @see
     * sernet.verinice.interfaces.search.ISearchService#update(sernet.verinice.
     * model.common.CnATreeElement)
     */
    @Override
