...
public class MultiSelectionList {
    ...
    public MultiSelectionList(ISelectOptionHandler entity, PropertyType type, Composite parent,
        ...
        for (Iterator<IMLPropertyOption> iter = options.iterator(); iter.hasNext();) {
            ...
            checkbox.addSelectionListener(new SelectionListener() {
                ...
                private void unselectOthers(IMLPropertyOption option) {
                    ArrayList<IMLPropertyOption> opts = (ArrayList<IMLPropertyOption>) type
                            .getOptions();
    ...
    private Composite createScrolledList() {
        ScrolledComposite scrollPane = new ScrolledComposite(group, SWT.V_SCROLL);
