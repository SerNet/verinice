...
public class SyncService_Service extends Service {
    ...
    private static final Logger LOG = Logger.getLogger(SyncService_Service.class);
    ...
    static {
        ...
        try {
            ...
            LOG.error("Can not initialize the default wsdl from file:src/sernet/verinice/service/sync/sync-service.wsdl", e);
        }
        WSDL_LOCATION = url;
    }
