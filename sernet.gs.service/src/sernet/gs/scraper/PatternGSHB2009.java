...
public class PatternGSHB2009 extends PatternGSHB2005_2006 {
	...
	final String GET_MASSNAHMEN = 
		...
		" for $a in //html:a" +
		" let $u := data($a/@href)" +
		" let $h := $a/../../../../preceding-sibling::html:h3[position()=1]" + // LZ: a/td/tr/tbody/table/h3
		...
		" and not ( contains($a/@href, \"../../m/m01.html\"))" + // not link to overview
	...
	final String GET_GEFAEHRDUNGEN = 
		...
		" let $h := $a/../../../../preceding-sibling::html:h3[position()=1]" + // KAT: a/td/tr/tbody/table/h3
	...
	/* (non-Javadoc)
	 * @see sernet.gs.scraper.PatternGSHB2005_2006#getEncoding()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sernet.gs.scraper.PatternGSHB2005_2006#getMassnahmePattern()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sernet.gs.scraper.PatternGSHB2005_2006#getGefaehrdungPattern()
	 */
	@Override
