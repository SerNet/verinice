...
/**
 * Source that reads BSI GS catalogues from within a ZIP file.
 * 
...
public class ZIPGSSource implements IGSSource {
    ...
    private Node parseDocument(InputStream inputstream, String encoding) throws TransformerConfigurationException, IOException, SAXException {
    ...
    public Node parseBausteinDocument(String bausteinFileName) throws GSServiceException {
        try {
            ...
            // Log stacktrace with debug level only
            log.debug("Error while parsing module: " + bausteinFileName, e);
