...
public class EvidenceGroup extends Group<Evidence> implements IISO27kGroup {
	...
	public EvidenceGroup(CnATreeElement parent) {
		super(parent);
	...
	public EvidenceGroup(CnATreeElement parent, String iconPath) {
        this(parent);
