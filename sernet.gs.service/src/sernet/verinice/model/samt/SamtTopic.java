...
public class SamtTopic extends CnATreeElement
    ...
    public void setDescription(String description) {
        getEntity().setSimpleValue(getEntityType().getPropertyType(SamtTopic.PROP_DESC),
                description);
    }
    ...
    /**
     * This method is using the same name as the related property in SNCA.xml.
     * 
     ...
     * 
     * @see
     * sernet.verinice.model.iso27k.IControl#setThreshold1(java.lang.String)
     */
     ...
     * 
     * @see
     * sernet.verinice.model.iso27k.IControl#setThreshold2(java.lang.String)
     */
    ...
    public void setOwnweight(String value) {
        getEntity().setSimpleValue(getEntityType().getPropertyType(SamtTopic.PROP_OWNWEIGHT),
                value);
    ...
    /**
     * Return the version of this topic. Can be null or empty. If no version is
     * set version is 1.x
     */
    ...
    /**
     * Sets the version of this topic. If no version is set version is 1.x
     * 
     * @param value
