 ...
 * 
 * Represents a unit of work started by a particular object and ended by that
 * object. Can be used to detect loops when traversing object graphs.
 * 
...
public class CascadingTransaction {
     ...
     * 
     * @param obj
     *            The object which should run inside the transaction
     * @return true if a new transation was created, false if object was added
     *         to existing transaction
     * @throws TransactionAbortedException
     *             if this transaction was aborted by one of the participants
     */
     ...
     * 
     * @param o
     *            the object ending the transaction. If not equal to the
     *            initiator this method does nothing.
     * @return
     */
