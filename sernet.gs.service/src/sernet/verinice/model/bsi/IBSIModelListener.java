...
public interface IBSIModelListener {
    ...
    /**
     * Request complete refresh of model, it depends on the listener how this
     * method will be implemented, i.e. what parts of the model really need to
     * be refreshed (only visible objects etc.).
     * 
     * @param source
     *            the cause or source for this model refresh. Should be the
     *            object causing the model change or one of the predefined
     *            sources given in {@link IBSIModelListener}.
     */
     ...
     * that it should reload from database.
     * 
     * @param child
     */
    ...
    /**
     * Element was deleted in database. Hint to view that it should reload from
     * database.
     * 
     * @param child
     */
    ...
    /**
     * Element was removed. Hint to view that it should reload from database.
     * 
     * @param entry
     *            entry from transaction log with details about deleted object
     */
    void databaseChildRemoved(ChangeLogEntry entry);

    /**
     * Element was changed in the database either by another client or by a
     * cascading action performed on the server.
     * 
