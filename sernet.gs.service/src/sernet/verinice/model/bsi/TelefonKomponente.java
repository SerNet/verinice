...
public class TelefonKomponente extends CnATreeElement implements IBSIStrukturElement {
    ...
    public static final String PROP_ESA_ENTSCHEIDUNG_DURCH = "tkkomponente_ergaenzendeanalyse_entscheidung_durch"; //$NON-NLS-1$
