...
public class ITVerbund extends CnATreeElement implements IBSIStrukturElement {
    ...
    public CnATreeElement getCategory(String id) {
        for (CnATreeElement category : getChildren()) {
            if (category.getTypeId() != null && category.getTypeId().equals(id)) {
    ...
    public boolean canContain(Object obj) {
        if (obj instanceof Baustein || obj instanceof BausteinUmsetzung
                || obj instanceof AnwendungenKategorie || obj instanceof ClientsKategorie
                || obj instanceof SonstigeITKategorie || obj instanceof GebaeudeKategorie
                || obj instanceof NKKategorie || obj instanceof PersonenKategorie
                || obj instanceof RaeumeKategorie || obj instanceof ServerKategorie
                || obj instanceof TKKategorie || obj instanceof FinishedRiskAnalysis) {
            return true;
        }
        return false;
    }
