...
public class MassnahmenSummaryHome {
    ...
    // FIXME ak creating links in linkmaker fails, after thagt no links can be
    // created not even by dragndrop

    // FIXME ak remove "Person" field from Configuration, replace with uuid as
