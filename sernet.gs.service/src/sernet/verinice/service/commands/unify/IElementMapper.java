...
/**
 * IElementMapper is used by command {@link LoadUnifyMapping} to create a
 * mapping between {@link CnATreeElement}s.
 * 
...
public interface IElementMapper {
     ...
     * If a source or destination element is not valid a
     * {@link UnifyValidationException} is thrown.
     * 
     * @param sourceMap
     ...
     *            no number (e.g. "1.2" for "1.2 IS Risk Management"). Value is
     *            the element.
     * @throws UnifyValidationException
     *             If a source or destination element is not valid
     */
    void validate(Map<String, CnATreeElement> sourceMap, Map<String, CnATreeElement> destinationMap)
            throws UnifyValidationException;
     ...
     */
    List<UnifyMapping> createMapping(Map<String, CnATreeElement> sourceMap,
