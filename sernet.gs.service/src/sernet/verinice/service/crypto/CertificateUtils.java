 ...
 * </p>
 * <p>
 * <i>Certificates, or to be more specific, public key certificates, provide a
 * mechanism that allows a third party, or issuer, to vouch for the fact that a
 * particular public key is linked with a particular owner, or subject.</i>
...
public final class CertificateUtils {
     ...
     *             </ul>
     */
    public static X509Certificate loadX509CertificateFromFile(File x509CertificateFile)
        ...
        // Since the file seems to be ok, try to make a X509 certificate from
        // it.
        ...
        try {
            ...
            // Shouldn't happen, since the BouncyCastle provider was added on
            // class loading
            // or even before
