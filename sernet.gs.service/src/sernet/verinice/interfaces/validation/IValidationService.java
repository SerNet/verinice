...
public interface IValidationService {
    ...
    /**
     * Creates validations for every validation rule defined in snca.xml for any
     * property of given element
     * 
     * @param elmt
     */
     ...
     * @param scope
     * @param monitor
     *            (use {@link IProgressMonitor} ) to provide feedback
     * @throws CommandException
     */
    void createValidationsForScope(Integer scope) throws CommandException;

    /**
     * creates validations for a cnatreeElement and all of its children
     * (recursivly)
     * 
     * @param elmt
     * @throws CommandException
     ...
     * @return
     */
    boolean isValidationExistant(Integer elmtDbId, String propertyType, String hintID,
            Integer scopeId);
    ...
    /**
     * Returns all validations for a specified {@link PropertType} of a given
     * {@link CnATreeElement}
     * 
     * @param elmtDbId
     * @param propertyType
    ...
    /**
     * returns all propertytypeids that needs to be validated for specified
     * cnatreeelement
     * 
     * @param dbid
     * @return
