...
public interface IReportService {
    ...
    String VERINICE_REPORTS_LOCAL = concat(
            concat(System.getProperty(IVeriniceConstants.USER_HOME), "verinice"),
            IReportTemplateService.REPORT_DEPOSIT_CLIENT_LOCAL); // $NON-NLS-1$
    ...
    ReportTemplateMetaData[] getReportTemplates(String[] rptDesignFiles)
