...
pipeline {
    ...
    parameters {
        string(name: 'jreversion', defaultValue: 'jdk-11.0.18+10', description: 'Download and pack a JRE with this version. See https://adoptopenjdk.net/archive.html for a list of possible versions.', trim: true)
