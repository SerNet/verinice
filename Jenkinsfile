...
pipeline {
    ...
    parameters {
        string(name: 'jreversion', defaultValue: 'jdk-11.0.20.1+1', description: 'Download and pack a JRE with this version. See https://adoptopenjdk.net/archive.html for a list of possible versions.', trim: true)
