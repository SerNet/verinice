...
/**
 * StgMapWaeId generated by hbm2java
 */
public class StgMapWaeId implements java.io.Serializable {
	...
	public StgMapWaeId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapWaeId))
			return false;
		StgMapWaeId castOther = (StgMapWaeId) other;
