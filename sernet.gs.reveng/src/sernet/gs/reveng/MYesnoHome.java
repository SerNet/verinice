...
/**
 * Home object for domain model class MYesno.
 * @see sernet.gs.reveng.MYesno
 * @author Hibernate Tools
 */
public class MYesnoHome {

	private static final Log log = LogFactory.getLog(MYesnoHome.class);
	...
	public void persist(MYesno transientInstance) {
		log.debug("persisting MYesno instance");
		try {
	...
	public MYesno merge(MYesno detachedInstance) {
		...
		try {
			MYesno result = (MYesno) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public MYesno findById(byte id) {
		log.debug("getting MYesno instance with id: " + id);
		try {
			MYesno instance = (MYesno) sessionFactory.getCurrentSession().get(
	...
	public List findByExample(MYesno instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MYesno")
