...
/**
 * TmpRepZobbauId generated by hbm2java
 */
public class TmpRepZobbauId implements java.io.Serializable {
	...
	public TmpRepZobbauId(int repId, int zobImpId, int zobId, int bauImpId,
			int bauId) {
		this.repId = repId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpRepZobbauId))
			return false;
		TmpRepZobbauId castOther = (TmpRepZobbauId) other;
