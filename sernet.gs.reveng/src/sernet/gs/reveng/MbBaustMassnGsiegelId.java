...
/**
 * MbBaustMassnGsiegelId generated by hbm2java
 */
public class MbBaustMassnGsiegelId implements java.io.Serializable {
	...
	public MbBaustMassnGsiegelId(int bauImpId, int bauId, int masImpId,
			int masId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MbBaustMassnGsiegelId))
			return false;
		MbBaustMassnGsiegelId castOther = (MbBaustMassnGsiegelId) other;
