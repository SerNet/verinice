...
/**
 * StgMbZielobjTypId generated by hbm2java
 */
public class StgMbZielobjTypId implements java.io.Serializable {

	private Integer zotId;
	private Integer zotImpId;
	private Integer lngImpId;
	private Integer notizId;
	private Integer vater;
	private String link;
	...
	public StgMbZielobjTypId() {
	}

	public StgMbZielobjTypId(Integer zotId, Integer zotImpId, Integer lngImpId,
			Integer notizId, Integer vater, String link, Byte metaNeu,
			Integer metaVers, Integer obsoletVers, String guid, Date timestamp,
			Date loeschDatum, Byte mtyId, Integer usn, String erfasstDurch,
			String geloeschtDurch, String guidOrg, Date cmTimestamp,
			String cmUsername, Short cmVerId2, Byte cmStaId, Short reihenfolge,
	...
	public Integer getVater() {
		return this.vater;
	}

	public void setVater(Integer vater) {
		this.vater = vater;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMbZielobjTypId))
			return false;
		StgMbZielobjTypId castOther = (StgMbZielobjTypId) other;
		...
		return ((this.getZotId() == castOther.getZotId()) || (this.getZotId() != null
				...
				&& ((this.getVater() == castOther.getVater()) || (this
						.getVater() != null && castOther.getVater() != null && this
						.getVater().equals(castOther.getVater())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getVater() == null ? 0 : this.getVater().hashCode());
		result = 37 * result
