...
/**
 * Home object for domain model class NmbNotiz.
 * @see sernet.gs.reveng.NmbNotiz
 * @author Hibernate Tools
 */
public class NmbNotizHome {

	private static final Log log = LogFactory.getLog(NmbNotizHome.class);
	...
	public void persist(NmbNotiz transientInstance) {
		log.debug("persisting NmbNotiz instance");
		try {
	...
	public NmbNotiz merge(NmbNotiz detachedInstance) {
		...
		try {
			NmbNotiz result = (NmbNotiz) sessionFactory.getCurrentSession()
	...
	public NmbNotiz findById(sernet.gs.reveng.NmbNotizId id) {
		...
		try {
			NmbNotiz instance = (NmbNotiz) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.NmbNotiz", id);
			if (instance == null) {
	...
	public List findByExample(NmbNotiz instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.NmbNotiz")
