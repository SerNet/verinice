...
/**
 * Home object for domain model class MMetastatus.
 * @see sernet.gs.reveng.MMetastatus
 * @author Hibernate Tools
 */
public class MMetastatusHome {

	private static final Log log = LogFactory.getLog(MMetastatusHome.class);
	...
	public void persist(MMetastatus transientInstance) {
		log.debug("persisting MMetastatus instance");
		try {
	...
	public MMetastatus merge(MMetastatus detachedInstance) {
		...
		try {
			MMetastatus result = (MMetastatus) sessionFactory
	...
	public MMetastatus findById(byte id) {
		log.debug("getting MMetastatus instance with id: " + id);
		try {
			MMetastatus instance = (MMetastatus) sessionFactory
					.getCurrentSession()
					.get("sernet.gs.reveng.MMetastatus", id);
			if (instance == null) {
	...
	public List findByExample(MMetastatus instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MMetastatus")
