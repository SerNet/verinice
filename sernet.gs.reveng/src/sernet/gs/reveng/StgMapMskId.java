...
/**
 * StgMapMskId generated by hbm2java
 */
public class StgMapMskId implements java.io.Serializable {
	...
	public StgMapMskId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapMskId))
			return false;
		StgMapMskId castOther = (StgMapMskId) other;
