...
/**
 * Home object for domain model class MSchutzbedarfkategTxt.
 * @see sernet.gs.reveng.MSchutzbedarfkategTxt
 * @author Hibernate Tools
 */
public class MSchutzbedarfkategTxtHome {

	private static final Log log = LogFactory
			.getLog(MSchutzbedarfkategTxtHome.class);
	...
	public void persist(MSchutzbedarfkategTxt transientInstance) {
		log.debug("persisting MSchutzbedarfkategTxt instance");
		try {
	...
	public MSchutzbedarfkategTxt merge(MSchutzbedarfkategTxt detachedInstance) {
		...
		try {
			MSchutzbedarfkategTxt result = (MSchutzbedarfkategTxt) sessionFactory
	...
	public MSchutzbedarfkategTxt findById(
		...
		try {
			MSchutzbedarfkategTxt instance = (MSchutzbedarfkategTxt) sessionFactory
					.getCurrentSession().get(
							"sernet.gs.reveng.MSchutzbedarfkategTxt", id);
			if (instance == null) {
	...
	public List findByExample(MSchutzbedarfkategTxt instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MSchutzbedarfkategTxt")
