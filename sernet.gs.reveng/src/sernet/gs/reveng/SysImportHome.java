...
/**
 * Home object for domain model class SysImport.
 * @see sernet.gs.reveng.SysImport
 * @author Hibernate Tools
 */
public class SysImportHome {

	private static final Log log = LogFactory.getLog(SysImportHome.class);
	...
	public void persist(SysImport transientInstance) {
		log.debug("persisting SysImport instance");
		try {
	...
	public SysImport merge(SysImport detachedInstance) {
		...
		try {
			SysImport result = (SysImport) sessionFactory.getCurrentSession()
	...
	public SysImport findById(int id) {
		log.debug("getting SysImport instance with id: " + id);
		try {
			SysImport instance = (SysImport) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.SysImport", id);
			if (instance == null) {
	...
	public List findByExample(SysImport instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.SysImport")
