...
/**
 * Home object for domain model class MbDringlichkeitTxt.
...
public class MbDringlichkeitTxtHome {
	...
	private static final Log log = LogFactory
			.getLog(MbDringlichkeitTxtHome.class);
	...
	public void persist(MbDringlichkeitTxt transientInstance) {
	...
	public MbDringlichkeitTxt merge(MbDringlichkeitTxt detachedInstance) {
		...
		try {
			MbDringlichkeitTxt result = (MbDringlichkeitTxt) sessionFactory
	...
	public MbDringlichkeitTxt findById(sernet.gs.reveng.MbDringlichkeitTxtId id) {
		...
		try {
			MbDringlichkeitTxt instance = (MbDringlichkeitTxt) sessionFactory
					.getCurrentSession().get(
							"sernet.gs.reveng.MbDringlichkeitTxt", id);
			if (instance == null) {
	...
	public List findByExample(MbDringlichkeitTxt instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MbDringlichkeitTxt")
