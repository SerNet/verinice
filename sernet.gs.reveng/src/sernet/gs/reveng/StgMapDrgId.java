...
/**
 * StgMapDrgId generated by hbm2java
 */
public class StgMapDrgId implements java.io.Serializable {
	...
	public StgMapDrgId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapDrgId))
			return false;
		StgMapDrgId castOther = (StgMapDrgId) other;
