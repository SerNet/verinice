...
/**
 * StgMapPhaId generated by hbm2java
 */
public class StgMapPhaId implements java.io.Serializable {
	...
	public StgMapPhaId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapPhaId))
			return false;
		StgMapPhaId castOther = (StgMapPhaId) other;
