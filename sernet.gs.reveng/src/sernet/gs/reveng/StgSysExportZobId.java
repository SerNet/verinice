...
/**
 * StgSysExportZobId generated by hbm2java
 */
public class StgSysExportZobId implements java.io.Serializable {
	...
	public StgSysExportZobId(Integer expId, Integer zobId, Integer zobImpId,
			Date timestamp) {
		this.expId = expId;
		this.zobId = zobId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgSysExportZobId))
			return false;
		StgSysExportZobId castOther = (StgSysExportZobId) other;
