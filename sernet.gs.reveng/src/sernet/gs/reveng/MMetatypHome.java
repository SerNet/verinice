...
/**
 * Home object for domain model class MMetatyp.
...
public class MMetatypHome {
	...
	public void persist(MMetatyp transientInstance) {
	...
	public MMetatyp merge(MMetatyp detachedInstance) {
		...
		try {
			MMetatyp result = (MMetatyp) sessionFactory.getCurrentSession()
	...
	public MMetatyp findById(byte id) {
		log.debug("getting MMetatyp instance with id: " + id);
		try {
			MMetatyp instance = (MMetatyp) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.MMetatyp", id);
			if (instance == null) {
	...
	public List findByExample(MMetatyp instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MMetatyp")
