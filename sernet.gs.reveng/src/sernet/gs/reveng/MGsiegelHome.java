...
/**
 * Home object for domain model class MGsiegel.
 * @see sernet.gs.reveng.MGsiegel
 * @author Hibernate Tools
 */
public class MGsiegelHome {

	private static final Log log = LogFactory.getLog(MGsiegelHome.class);
	...
	public void persist(MGsiegel transientInstance) {
		log.debug("persisting MGsiegel instance");
		try {
	...
	public MGsiegel merge(MGsiegel detachedInstance) {
		...
		try {
			MGsiegel result = (MGsiegel) sessionFactory.getCurrentSession()
	...
	public MGsiegel findById(short id) {
		log.debug("getting MGsiegel instance with id: " + id);
		try {
			MGsiegel instance = (MGsiegel) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.MGsiegel", id);
			if (instance == null) {
	...
	public List findByExample(MGsiegel instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MGsiegel")
