...
/**
 * StgMapMasId generated by hbm2java
 */
public class StgMapMasId implements java.io.Serializable {
	...
	public StgMapMasId(int altId, int altImpId, int neuId, int neuImpId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapMasId))
			return false;
		StgMapMasId castOther = (StgMapMasId) other;
