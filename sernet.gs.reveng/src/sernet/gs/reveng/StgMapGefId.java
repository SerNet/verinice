...
/**
 * StgMapGefId generated by hbm2java
 */
public class StgMapGefId implements java.io.Serializable {
	...
	public StgMapGefId(int altId, int altImpId, int neuId, int neuImpId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapGefId))
			return false;
		StgMapGefId castOther = (StgMapGefId) other;
