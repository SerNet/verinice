...
/**
 * CmZotState generated by hbm2java
 */
public class CmZotState implements java.io.Serializable {

	private CmZotStateId id;
	...
	public CmZotState(CmZotStateId id, MsCmState msCmState, byte cmVerId2,
	...
	public CmZotStateId getId() {
		return this.id;
	}

	public void setId(CmZotStateId id) {
		this.id = id;
	}
