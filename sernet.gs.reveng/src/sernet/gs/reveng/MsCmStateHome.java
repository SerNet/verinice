...
/**
 * Home object for domain model class MsCmState.
 * @see sernet.gs.reveng.MsCmState
 * @author Hibernate Tools
 */
public class MsCmStateHome {

	private static final Log log = LogFactory.getLog(MsCmStateHome.class);
	...
	public void persist(MsCmState transientInstance) {
		log.debug("persisting MsCmState instance");
		try {
	...
	public MsCmState merge(MsCmState detachedInstance) {
		...
		try {
			MsCmState result = (MsCmState) sessionFactory.getCurrentSession()
	...
	public MsCmState findById(byte id) {
		log.debug("getting MsCmState instance with id: " + id);
		try {
			MsCmState instance = (MsCmState) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.MsCmState", id);
			if (instance == null) {
	...
	public List findByExample(MsCmState instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MsCmState")
