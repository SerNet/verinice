...
/**
 * StgMapZeiId generated by hbm2java
 */
public class StgMapZeiId implements java.io.Serializable {
	...
	public StgMapZeiId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapZeiId))
			return false;
		StgMapZeiId castOther = (StgMapZeiId) other;
