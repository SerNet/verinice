...
/**
 * Home object for domain model class MBstnStatus.
 * @see sernet.gs.reveng.MBstnStatus
 * @author Hibernate Tools
 */
public class MBstnStatusHome {

	private static final Log log = LogFactory.getLog(MBstnStatusHome.class);
	...
	public void persist(MBstnStatus transientInstance) {
		log.debug("persisting MBstnStatus instance");
		try {
	...
	public MBstnStatus merge(MBstnStatus detachedInstance) {
		...
		try {
			MBstnStatus result = (MBstnStatus) sessionFactory
	...
	public MBstnStatus findById(byte id) {
		log.debug("getting MBstnStatus instance with id: " + id);
		try {
			MBstnStatus instance = (MBstnStatus) sessionFactory
					.getCurrentSession()
					.get("sernet.gs.reveng.MBstnStatus", id);
			if (instance == null) {
	...
	public List findByExample(MBstnStatus instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MBstnStatus")
