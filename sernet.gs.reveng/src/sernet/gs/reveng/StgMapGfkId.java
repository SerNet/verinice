...
/**
 * StgMapGfkId generated by hbm2java
 */
public class StgMapGfkId implements java.io.Serializable {
	...
	public StgMapGfkId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapGfkId))
			return false;
		StgMapGfkId castOther = (StgMapGfkId) other;
