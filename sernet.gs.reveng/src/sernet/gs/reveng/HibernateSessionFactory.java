 ...
 * 
 * <p>
 * The creation of {@link Session} instances is managed through the Spring class
 * {@link LocalSessionFactoryBean}. By using this class the loading of the
 * mappings can be done using the right class loader in an OSGi environment. For
 * a non-OSGi environment this has no effect.
 * </p>
 * 
 * <p>
 * This class needs spring-orm and spring-core.
 * </p>
 */
public class HibernateSessionFactory {
    ...
    private static void rebuildSessionFactory() {
        try {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("New session factory for GSTOOL import created, configuration file: " + configLocation);
            }
        } catch (Exception e) {
            LOG.error("Error while rebuilding session factory.", e);
        }
    }
    ...
    /**
     * Provides a location in the local filesystem where the hibernate
     * configuration is located.
     * 
     * <p>
     * Changing the location requires all previously opened sessions to be
     * closed. An {@link IllegalStateException} is thrown if this precondition
     * is violated.
     * </p>
     */
    ...
    /**
     * Provides an arbitrary URL which points to a hibernate configuration.
     * 
     * <p>
     * Changing the location requires all previously opened sessions to be
     * closed. An {@link IllegalStateException} is thrown if this precondition
