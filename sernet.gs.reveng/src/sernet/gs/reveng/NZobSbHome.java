...
/**
 * Home object for domain model class NZobSb.
 * @see sernet.gs.reveng.NZobSb
 * @author Hibernate Tools
 */
public class NZobSbHome {

	private static final Log log = LogFactory.getLog(NZobSbHome.class);
	...
	public void persist(NZobSb transientInstance) {
		log.debug("persisting NZobSb instance");
		try {
	...
	public NZobSb merge(NZobSb detachedInstance) {
		...
		try {
			NZobSb result = (NZobSb) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public NZobSb findById(sernet.gs.reveng.NZobSbId id) {
		...
		try {
			NZobSb instance = (NZobSb) sessionFactory.getCurrentSession().get(
	...
	public List findByExample(NZobSb instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.NZobSb")
