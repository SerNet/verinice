...
/**
 * StgMapStaId generated by hbm2java
 */
public class StgMapStaId implements java.io.Serializable {
	...
	public StgMapStaId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapStaId))
			return false;
		StgMapStaId castOther = (StgMapStaId) other;
