...
/**
 * Home object for domain model class NZielobjektRollen.
 * @see sernet.gs.reveng.NZielobjektRollen
 * @author Hibernate Tools
 */
public class NZielobjektRollenHome {

	private static final Log log = LogFactory
			.getLog(NZielobjektRollenHome.class);
	...
	public void persist(NZielobjektRollen transientInstance) {
		log.debug("persisting NZielobjektRollen instance");
		try {
	...
	public NZielobjektRollen merge(NZielobjektRollen detachedInstance) {
		...
		try {
			NZielobjektRollen result = (NZielobjektRollen) sessionFactory
	...
	public NZielobjektRollen findById(sernet.gs.reveng.NZielobjektRollenId id) {
		...
		try {
			NZielobjektRollen instance = (NZielobjektRollen) sessionFactory
	...
	public List findByExample(NZielobjektRollen instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.NZielobjektRollen")
