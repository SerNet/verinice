...
/**
 * StgMapZotId generated by hbm2java
 */
public class StgMapZotId implements java.io.Serializable {
	...
	public StgMapZotId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapZotId))
			return false;
		StgMapZotId castOther = (StgMapZotId) other;
