...
/**
 * MbB2mDelId generated by hbm2java
 */
public class MbB2mDelId implements java.io.Serializable {
	...
	public MbB2mDelId(int impId, int bauImpId, int bauId, int masImpId,
			int masId) {
		this.impId = impId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MbB2mDelId))
			return false;
		MbB2mDelId castOther = (MbB2mDelId) other;
