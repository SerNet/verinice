...
/**
 * NZielobjektId entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class NZielobjektId implements java.io.Serializable {
	...
	/** default constructor */
	public NZielobjektId() {
	}

	/** full constructor */
	public NZielobjektId(Integer zobImpId, Integer zobId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NZielobjektId))
			return false;
		NZielobjektId castOther = (NZielobjektId) other;
