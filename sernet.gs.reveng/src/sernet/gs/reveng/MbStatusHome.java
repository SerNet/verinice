...
/**
 * Home object for domain model class MbStatus.
 * @see sernet.gs.reveng.MbStatus
 * @author Hibernate Tools
 */
public class MbStatusHome {

	private static final Log log = LogFactory.getLog(MbStatusHome.class);
	...
	public void persist(MbStatus transientInstance) {
		log.debug("persisting MbStatus instance");
		try {
	...
	public MbStatus merge(MbStatus detachedInstance) {
		...
		try {
			MbStatus result = (MbStatus) sessionFactory.getCurrentSession()
	...
	public MbStatus findById(sernet.gs.reveng.MbStatusId id) {
		...
		try {
			MbStatus instance = (MbStatus) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.MbStatus", id);
			if (instance == null) {
	...
	public List findByExample(MbStatus instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MbStatus")
