...
/**
 * Home object for domain model class MbSchicht.
 * @see sernet.gs.reveng.MbSchicht
 * @author Hibernate Tools
 */
public class MbSchichtHome {

	private static final Log log = LogFactory.getLog(MbSchichtHome.class);
	...
	public void persist(MbSchicht transientInstance) {
		log.debug("persisting MbSchicht instance");
		try {
	...
	public MbSchicht merge(MbSchicht detachedInstance) {
		...
		try {
			MbSchicht result = (MbSchicht) sessionFactory.getCurrentSession()
	...
	public MbSchicht findById(sernet.gs.reveng.MbSchichtId id) {
		...
		try {
			MbSchicht instance = (MbSchicht) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.MbSchicht", id);
			if (instance == null) {
	...
	public List findByExample(MbSchicht instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MbSchicht")
