...
/**
 * StgMapZobId generated by hbm2java
 */
public class StgMapZobId implements java.io.Serializable {
	...
	public StgMapZobId(int altId, int altImpId, int neuId, int neuImpId,
			boolean inserted) {
		this.altId = altId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMapZobId))
			return false;
		StgMapZobId castOther = (StgMapZobId) other;
