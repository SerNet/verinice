...
/**
 * Home object for domain model class MbZielobjTyp.
 * @see sernet.gs.reveng.MbZielobjTyp
 * @author Hibernate Tools
 */
public class MbZielobjTypHome {

	private static final Log log = LogFactory.getLog(MbZielobjTypHome.class);
	...
	public void persist(MbZielobjTyp transientInstance) {
		log.debug("persisting MbZielobjTyp instance");
		try {
	...
	public MbZielobjTyp merge(MbZielobjTyp detachedInstance) {
		...
		try {
			MbZielobjTyp result = (MbZielobjTyp) sessionFactory
	...
	public MbZielobjTyp findById(sernet.gs.reveng.MbZielobjTypId id) {
		...
		try {
			MbZielobjTyp instance = (MbZielobjTyp) sessionFactory
					.getCurrentSession().get("sernet.gs.reveng.MbZielobjTyp",
							id);
			if (instance == null) {
	...
	public List findByExample(MbZielobjTyp instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MbZielobjTyp")
