...
/**
 * Home object for domain model class MbBaust.
 * @see sernet.gs.reveng.MbBaust
 * @author Hibernate Tools
 */
public class MbBaustHome {

	private static final Log log = LogFactory.getLog(MbBaustHome.class);
	...
	public void persist(MbBaust transientInstance) {
		log.debug("persisting MbBaust instance");
		try {
	...
	public MbBaust merge(MbBaust detachedInstance) {
		...
		try {
			MbBaust result = (MbBaust) sessionFactory.getCurrentSession()
	...
	public MbBaust findById(sernet.gs.reveng.MbBaustId id) {
		...
		try {
			MbBaust instance = (MbBaust) sessionFactory.getCurrentSession()
					.get("sernet.gs.reveng.MbBaust", id);
			if (instance == null) {
	...
	public List findByExample(MbBaust instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("sernet.gs.reveng.MbBaust")
