...
/**
 * StgMbBauMasGefId generated by hbm2java
 */
public class StgMbBauMasGefId implements java.io.Serializable {
	...
	public StgMbBauMasGefId(Integer impId, Integer bauId, Integer bauImpId,
			Integer masId, Integer masImpId, Integer gefId, Integer gefImpId,
			Byte sbkIdVert, Byte sbkIdVerf, Byte sbkIdInteg, Integer metaVers,
	...
	public void setSbkIdVert(Byte sbkIdVert) {
		this.sbkIdVert = sbkIdVert;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StgMbBauMasGefId))
			return false;
		StgMbBauMasGefId castOther = (StgMbBauMasGefId) other;
		...
		return ((this.getImpId() == castOther.getImpId()) || (this.getImpId() != null
				...
				&& ((this.getSbkIdVert() == castOther.getSbkIdVert()) || (this
						.getSbkIdVert() != null
						&& castOther.getSbkIdVert() != null && this
						.getSbkIdVert().equals(castOther.getSbkIdVert())))
	...
	public int hashCode() {
		...
		result = 37 * result
				+ (getSbkIdVert() == null ? 0 : this.getSbkIdVert().hashCode());
		result = 37 * result
