 ...
 *
 */
public class EvidenceCommandFactory implements ICommandFactory {
    ...
    public LoadElementByClass getElementCommand() {
        return new LoadElementByClass<FindingGroup>(new FindingGroup());
    }
    ...
    public LoadLinkedElements getLinkedElementCommand(int selectedId) {
        return new LoadLinkedElements(Arrays.asList(new Class[]{FindingGroup.class,Finding.class}),selectedId);
    }
