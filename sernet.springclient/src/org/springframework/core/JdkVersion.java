...
/**
 * This is a hacked class, which will be added to the spring-core-verinice-patch.jar in favor
 * of the original class, which don't work with 1.5. This class needs compiling 
 * and to be placed in the spring-core-verinice-patch.jar.
 * @author Rod Johnson
...
public abstract class JdkVersion {
    ...
    /**
     * Constant identifying the 11.x JVM (Java 11).
     */
    public static final int JAVA_11 = 6;
    ...
    /**
     * Convenience method to determine if the current JVM is at least Java 1.5
     * (Java 5).
     * 
